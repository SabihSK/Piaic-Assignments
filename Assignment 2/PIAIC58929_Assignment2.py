...
def function8():
    ...
    x = np.ones(10).reshape(2, 5) #write your code here
    x = x*6
    return x
...
def function10():
    ...
    brr = np.array([1,2,3])
    subt = np.full_like(arr, 2) # write your code here 
...
def function13():
    ...
    ans = ((arr>5) & (arr<10)) #write your code here 
...
def function16():
    ...
    x = np.array([[1], [2], [3]])
    y = np.array([[2], [3], [4]])
    ans = np.concatenate((x,y)).reshape((3,1,-1) , order="F") #write your code here 
